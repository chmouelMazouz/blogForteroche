    <div id="index-banner" class="parallax-container">
        <div class="section no-pad-bot">
            <div class="container">
                <br><br>
                <h1 class="header center title-style">Le blog de Jean Forteroche</h1>
                <div class="row center">
                    <h5 class="header col s12 light">Un billet pour l'alaska</h5>
                </div>
                <div class="row center">
                    <a href="index.php?controller=articleController&task=indexArticle" id="download-button" class="btn-large waves-effect waves-light teal lighten-1">Voir les articles</a>
                </div>
                <br><br>
            </div>
        </div>
        <div class="parallax"><img src="images/background1.jpg" alt="Unsplashed background img 1">
        </div>
    </div>
    <div class="container">
        <h2>Derniers billets publiés</h2>
        <div class="row">
